...
def read_from_db():
    c.execute("SELECT keyword, unix FROM stuffToPlot WHERE unix > 1451255552")
    #data = c.fetchall()
    #print(data)
...
def del_and_update():
    ...
    # c.execute("SELECT * FROM stuffToPlot WHERE value = 99")
    # conn.commit()
    # print(50 * '#')
...
# Ensure the table is created before any operations
# create_table()
# data_entry()
# for i in range(10):
#   dynamic_data_entry()
